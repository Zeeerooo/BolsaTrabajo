...
class LoginForm(forms.Form):
    ...
    password = forms.CharField(label='Ingresa tu contraseña', required=True, error_messages={'required': 'Campo Obligatorio'}, widget=forms.PasswordInput(attrs={'autocomplete':'off','placeholder': 'Contraseña', 'class' : 'form-control'}))
...
class SignUpForm(UserCreationForm):
    ...
    password1 = forms.CharField(label='Ingresa tu contraseña', required=True, error_messages={'required': 'Campo Obligatorio'}, widget=forms.PasswordInput(attrs={'autocomplete':'off','placeholder': 'Contraseña', 'class' : 'form-control'}))
    password2 = forms.CharField(label='Repetir Contraseña', required=True, error_messages={'required': 'Contraseñas deben coincidir'}, widget=forms.PasswordInput(attrs={'autocomplete':'off','placeholder': 'Repetir Contraseña', 'class' : 'form-control'}))
